...
data_path = (
    ...
    + "/fullshuffle-bildresnet50attentionahlstmRLoss/"
)
...
# Calculate RMSE for each position channel
channel_losses = []
for i in range(3):
